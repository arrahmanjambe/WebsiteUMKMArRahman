...
export const FAQ_ITEMS: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Kami menyediakan berbagai produk anyaman bambu handmade, antara lain:\n• Topi Fedora — model klasik elegan dengan aksen modern\n• Topi Koboy — desain western yang kokoh dan berkarakter\n• Topi Lutfy — brim lebar dengan sentuhan warna ceria\n• Peci Anyaman Bambu — perpaduan tradisional dan modern dengan bahan premium\n\nSemua produk dibuat secara manual dari serat bambu alami dan dapat disesuaikan (custom) sesuai kebutuhan. Koleksi dapat terus berkembang mengikuti tren dan permintaan pelanggan.",
  },
  {
    id: "faq-003",
    category: "pemesanan",
  ...
  },
  {
    ...
    answer:
      "Ya. Produk kami menggunakan bambu alami, sehingga lebih ramah lingkungan dibandingkan plastik. Bambu juga merupakan tanaman yang tumbuh sangat cepat dan tidak memerlukan pestisida, menjadikannya salah satu bahan baku paling sustainable. Proses produksi kami juga meminimalkan limbah yang dihasilkan.",
  },
  {
    id: "faq-005",
    category: "pemesanan",
  ...
  },
  {
    ...
    answer:
      "Ya, kami melayani:\n• Pengiriman ke seluruh Indonesia via layanan ekspedisi \n\nUntuk pengiriman, silakan hubungi kami terlebih dahulu untuk pembahasan detail biaya, jadwal, dan lokasi tujuan.",
  },
  {
    id: "faq-008",
    category: "perawatan",
